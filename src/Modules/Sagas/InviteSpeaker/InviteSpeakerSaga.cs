...
namespace Confab.Modules.Sagas.InviteSpeaker;

internal class InviteSpeakerSaga
    : Saga<InviteSpeakerSaga.SagaData>,
        ...
        ISagaAction<SignedIn>
{
    ...
    internal class SagaData
    {
        ...
        public readonly Dictionary<string, string> InvitedSpeakers =
            new()
            {
