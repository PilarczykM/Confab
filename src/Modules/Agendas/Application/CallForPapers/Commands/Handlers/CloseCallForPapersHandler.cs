...
{
    public class CloseCallForPapersHandler : ICommandHandler<OpenCallForPapers>
    {
        private readonly ICallForPapersRepository _callForPapersRepository;
        private readonly IMessageBroker _messageBroker;

        public CloseCallForPapersHandler(
        ...
        public async Task HandleAsync(OpenCallForPapers command)
        {
            ...
            await _messageBroker.PublishAsync(new CallForPapersClosed(callForPaper.ConferenceId));
        }
    }
}
